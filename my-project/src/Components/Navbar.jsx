    ...
    return (
        <div className='w-full flex items-center justify-center p-2'>
            <div className='flex text-white'>
                <ul className='fixed z-50 top-8 inset-x-0 mx-auto p-4 md:px-5 md:py-5 rounded-lg border border-black shadow-lg md:backdrop-blur-3xl md:backdrop-saturate-[150%] flex items-center max-w-[600px] justify-evenly space-x-3 md:space-x-2'>
